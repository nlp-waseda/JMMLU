...
## 非正式版本，日后可能有变动
JMMLU由MMLU的日语翻译和基于日本独特文化背景的内容两部分构成。

我们从MMLU的 57 项任务中，每项任务最多选取 150 个问题，首先用机器翻译成日语。 然后，翻译人员检查机器翻译结果，删除难以翻译或与日本文化不相关或不一致的问题和任务。

剩下的问题则经过校对和修改使之成为流畅的日语。 此外还增加了公民和日本史等基于日本学校教纲的问题的科目。
...
日语成语、公民和日本地理的版权归VIST学习塾所有，采用 CC BY-NC-ND 4.0 许可证。
